...
public class HeadBobController : MonoBehaviour
{
    ...
    {
        if (!GameManager.Focused || playerMovement.coyoteTimeCounter == 0 || playerMovement.currentMovementState == PlayerMovement.MovementStates.Sliding || playerMovement.horizontalInput == 0 && playerMovement.verticalInput == 0) return;
